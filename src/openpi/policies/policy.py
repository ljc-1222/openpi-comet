...
class PolicyRecorder(_base_policy.BasePolicy):
    ...
    def infer_with_prefix_z(self, obs: dict, *, noise: np.ndarray | None = None) -> dict:
        if not hasattr(self._policy, "infer_with_prefix_z"):
            raise NotImplementedError("Recorded policy does not expose infer_with_prefix_z.")
        results = self._policy.infer_with_prefix_z(obs, noise=noise)
